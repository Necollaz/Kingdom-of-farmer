...
using UnityEngine;
using BaseGame.Scripts.Gameplay.Common.Collisions;

namespace BaseGame.Scripts.Gameplay.Common.Physics
{
    public class PhysicsService : IPhysicsService
    {
        ...
        public TEntity OverlapPoint<TEntity>(Vector2 worldPosition, int layerMask)
            where TEntity : class
        {
        ...
        public int OverlapCircle(Vector3 worldPos, float radius, Collider2D[] hits, int layerMask) => Physics2D.OverlapCircleNonAlloc(worldPos, radius, hits, layerMask);
