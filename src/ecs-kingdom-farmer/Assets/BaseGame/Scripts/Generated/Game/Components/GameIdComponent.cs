...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Common.Id id { get { return (BaseGame.Scripts.Gameplay.Common.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public GameEntity AddId(int newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Common.Id)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Common.Id));
