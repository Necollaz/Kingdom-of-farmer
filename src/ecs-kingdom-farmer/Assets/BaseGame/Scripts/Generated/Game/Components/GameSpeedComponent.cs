...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Features.Movement.Speed speed { get { return (BaseGame.Scripts.Gameplay.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Features.Movement.Speed)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Features.Movement.Speed));
