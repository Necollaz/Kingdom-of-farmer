...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Common.DamageTakenAnimator damageTakenAnimator { get { return (BaseGame.Scripts.Gameplay.Common.DamageTakenAnimator)GetComponent(GameComponentsLookup.DamageTakenAnimator); } }
    ...
    public GameEntity AddDamageTakenAnimator(Code.Gameplay.Common.Visuals.IDamageTakenAnimator newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Common.DamageTakenAnimator)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Common.DamageTakenAnimator));
