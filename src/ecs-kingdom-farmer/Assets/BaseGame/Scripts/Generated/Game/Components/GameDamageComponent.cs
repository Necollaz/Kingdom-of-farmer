...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Common.Damage damage { get { return (BaseGame.Scripts.Gameplay.Common.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Common.Damage)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Common.Damage));
