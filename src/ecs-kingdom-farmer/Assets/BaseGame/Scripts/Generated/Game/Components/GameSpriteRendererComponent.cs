...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Common.SpriteRendererComponent spriteRenderer { get { return (BaseGame.Scripts.Gameplay.Common.SpriteRendererComponent)GetComponent(GameComponentsLookup.SpriteRenderer); } }
    ...
    public GameEntity AddSpriteRenderer(UnityEngine.SpriteRenderer newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Common.SpriteRendererComponent)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Common.SpriteRendererComponent));
