...
public partial class GameEntity {
    ...
    public BaseGame.Scripts.Gameplay.Input.AxisInput axisInput { get { return (BaseGame.Scripts.Gameplay.Input.AxisInput)GetComponent(GameComponentsLookup.AxisInput); } }
    ...
    public GameEntity AddAxisInput(UnityEngine.Vector3 newValue) {
        ...
        var component = (BaseGame.Scripts.Gameplay.Input.AxisInput)CreateComponent(index, typeof(BaseGame.Scripts.Gameplay.Input.AxisInput));
